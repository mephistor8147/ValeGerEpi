        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="p-8">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full bg-white border border-gray-200 text-gray-700 font-bold rounded-xl py-4 flex items-center justify-center gap-3 shadow-sm hover:bg-gray-50 hover:border-gray-300 transition-colors mb-6 disabled:opacity-50"
                >
                ...
                <div className="relative flex items-center justify-center mb-6">
                    ...
                    <div className="relative bg-white px-4 text-sm text-gray-400 font-medium tracking-wide">OU E-MAIL</div>
                </div>
